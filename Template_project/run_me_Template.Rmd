...
scripts.dir <- "L:/Lab/NHEERL_MEA/CCTE_Shafer pre-process for TCPL/script_repos/CCTE_Shafer_MEA_dev_pre-processing_scripts/R" # directory containing the pre-processing scripts for the NFA
root.output.dir <- "L:/Lab/NHEERL_MEA/CCTE_Shafer pre-process for TCPL/project_repos/CCTE_Shafer_MEA_dev_pre-processing_projects" # main directory where the output should be saved
