...
For a step-by-step guide, see `documentation/guide_to_prepare_mea_nfa_level0_for_tcpl.html`. This guide was designed for pre-processing data from the Network Formation Assay done in the EPA Shafer Lab, but it can be adapted for others.
