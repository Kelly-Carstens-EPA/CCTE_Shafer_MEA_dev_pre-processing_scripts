...
wllq.by.well.desc <- data.table(
  ...
  'Description' = c("Comma-separated list of which assays the well-quality affects, including mea, AB (Alamar Blue, aka Cell Titer Blue), or LDH",
