...
source(file.path(scripts.dir,'cytotox_prep06.R'))
```
...
run_cytotox_functions(project.output.dir, project_name, get_files_from_log = TRUE, cytoFiles = NULL)
...
```{r}
rm(list = setdiff(ls(),c('project_name','pause_between_steps','save_notes_graphs','default_ControlTreatmentName','spidmap_file','spid_sheet','project.input.dir','scripts.dir','root.output.dir','update_concs_without_prompt','get_new_files_log')))
setwd(root.output.dir)
```
