...
# USER INPUT
# ------------------------------------------------------------------------ #
project_name <- "DNT_NTP2021" # the name for the current dataset, e.g. "name2020" (this should match the name of the folder under 'pre-process_mea_nfa_for_tcpl', e.g. 'Frank2017' or 'ToxCast2016')
...
scripts.dir <- "C:/Users/acarpe01/Documents/local_repos/CCTE_Shafer_MEA_dev_pre-processing_scripts_test/R" # update to the folder where the scripts are located
root_output_dir <- "C:/Users/acarpe01/Documents/local_repos/data_process_prac" # where the project_name folder will be created

update_concs_without_prompt <- FALSE

get_new_files_log <- FALSE # using a dummy created one, for now
# ------------------------------------------------------------------------ #
# END USER INPUT
# ------------------------------------------------------------------------ #
...
rm(list = setdiff(ls(),c('project_name','pause_between_steps','save_notes_graphs','default_ControlTreatmentName','spidmap_file','spid_sheet','project.dir','scripts.dir','root_output_dir','update_concs_without_prompt','get_new_files_log')))
...
save(dat, description, file = file.path(root_output_dir, project_name, "output", paste0(project_name,"_longfile.RData")))
rm(dat)
